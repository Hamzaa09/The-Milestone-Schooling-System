          ...
          <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-5">
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <ul className="mt-6 space-y-2 md:space-y-4">
                ...
                <li className="flex gap-2 justify-start items-center text-base text-black transition-all duration-200 hover:text-[#2e6fd4] focus:text-[#2e6fd4]">
                  <span className="text-[#1f5fc4] mt-0.5">
                    <FaLocationDot />
                  </span>
